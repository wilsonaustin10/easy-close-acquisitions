  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'conversion', {
        'send_to': 'AW-17603413995/YlK2CJO4uqIbEOuP-8lB',
      });
    }
  }, []);
      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            One of our business acquisition specialists will contact you shortly with your valuation
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We&apos;ll review your business details and contact you immediately with a fair valuation
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Once you accept our offer, we can close as quickly as 30 days or on your preferred timeline
                </p>
              </div>
            </div>
          </div>
