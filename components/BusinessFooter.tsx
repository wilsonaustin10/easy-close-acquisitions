    ...
    <footer className="bg-secondary text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Plumbing & HVAC Services</li>
              <li className="text-white/80">Roofing Companies</li>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/80">
          <p>© {new Date().getFullYear()} Easy Close Acquisitions. All rights reserved.</p>
