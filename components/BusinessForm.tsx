            ...
            <div className="grid gap-3">
              {businessTypes.map((type) => (
                <button
                  ...
                  className="w-full text-left p-3 sm:p-4 rounded-lg border-2 border-gray-200 hover:border-primary hover:bg-primary/5 active:bg-primary/10 transition-all duration-200 flex items-center justify-between group min-h-[48px]"
                >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg border border-gray-300 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 text-base"
                required
              />
              <input
                type="text"
    ...
    <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6">
      ...
      {step > 1 && step < 5 && (
        <button
          type="button"
          onClick={handleBack}
          className="mt-4 px-4 py-2 text-gray-600 hover:text-primary transition-colors font-medium"
        >
          ← Back
        </button>
      )}
